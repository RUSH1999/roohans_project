    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
               <!-- <span id="price"><b>Rs.</b><?php echo $inv[0]['price'] ?></span>-->
                <br>
               <!-- <span><small><b>Available Pets:</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>-->
                </div>
                <a href="https://forms.gle/dmvqMbhN62NpdnF86"><button class="btn btn-outline-dark flex-shrink-0" type="submit">
...
---->
                ...
                <div class="d-flex">
                    ...
                    <a href="https://www.youtube.com/"><button class="btn btn-outline-dark flex-shrink-0" type="submit">
                        <i class="bi-cart-fill me-1"></i>
                        Add to Wishlist
                    </button></a>
                </div>
                ...
                <p class="lead mt-5 "><b>Details:</b><br><?php echo stripslashes(html_entity_decode($description)) ?></p>
